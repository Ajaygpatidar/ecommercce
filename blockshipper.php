...
<div id="page-wrapper">
    <div class="container-fluid well" >
        <center><h2>View Non-Verified Shipper</h2></center>
                ...
                <table id="mytable" class="table table-striped table-bordered">  
                    ...
                    <tbody>
                        ...
                        <tr>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo site_url('welcome/shipper_update/'.$uid);?>" method="post">
                            ...
                            <a href="<?php echo site_url('welcome/verifyblockshipper/'.$uid)?>" type="submit "  class="btn btn-success btn-xs" data-toggle="modal">verify</a>

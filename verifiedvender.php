...
<div id="page-wrapper">
    <div class="container-fluid well" >
        <center><h2>View Verified Vender</h2></center>
                ...
                <table id="mytable" class="table table-striped table-bordered">  
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo site_url('welcome/blockverifyvender/'.$uid)?>" type="submit "  class="btn btn-danger btn-xs" data-toggle="modal">Block</a>

...
<div id="page-wrapper">
    <div class="container-fluid well" >
        <center><h2>View Non- Verified Product</h2></center>
                ...
                <table id="mytable" class="table table-striped table-bordered">  
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo site_url('welcome/verifyproduct/'.$pid)?>" class="btn btn-success btn-xs" >Veify</a>
                            <a href="<?php echo site_url('welcome/deletenonverifyproduct/'.$pid)?>" class="btn btn-danger btn-xs" >Delete</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
